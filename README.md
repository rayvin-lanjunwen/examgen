...
**交互模式** — 考试模式（统一作答批阅）/ **闯关模式**（逐题即时判分）— 详见下方 [交互模式](#交互模式)

## 功能特性

- **双模式** — 考试模式（统一提交批阅）和闯关模式（逐题作答即时判分），上传时选择
...
- **4 种视觉主题** — 现代教育 / 学术纸本 / 专业工具 / 碧绿清新，上传或命令行可选
